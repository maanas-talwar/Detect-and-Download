'''
	...
	Purpose : To fetch the latest release versions of postgreSQL and download those versions which are not already downloaded.
...
if __name__ == '__main__':
	...
	url_download = 'https://ftp.postgresql.org/pub/source/v'

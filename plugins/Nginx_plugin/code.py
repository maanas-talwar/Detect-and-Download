...
class Nginx(abstractPlugin.pluginBlueprint):
    ...
    def update_json(self):
        ...
        for i in range(len(new_releases)):
            ...
            with open(cur_path + "/data/Nginx.json", 'r+') as file:

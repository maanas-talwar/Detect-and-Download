...
class MariaDB(abstractPlugin.pluginBlueprint):
    ...
    url_check_release = "https://mariadb.org/"

    # variable to store the basic url(adding version required in place of *) for downloading
    url_download = "https://downloads.mariadb.org/interstitial/mariadb-*/source/mariadb-*.tar.gz/from/http%3A//mirrors.piconets.webwerks.in/mariadb-mirror/"
